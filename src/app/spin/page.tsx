    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white text-slate-900 p-6">
      <div className="max-w-6xl mx-auto pt-10">
        ...
        <p className="mt-2 text-slate-600">
          Upload a short spin video (8–12s). We extract <b>36 frames</b> in the browser and render a simple 360° viewer (drag to rotate).
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          ...
          <div className="rounded-xl border bg-white/70 backdrop-blur p-3 shadow">
            {!frames.length ? (
              ...
              >
                <Sprite360 frames={frames} index={current} />
                <div className="text-right text-[10px] text-slate-400">{current + 1}/36</div>
              </div>
            )}
          </div>
        </div>
